...
void charClear(char row, char column);
void stringDraw( uint8_t row, uint8_t col, uint8_t *word, int setclear);
...
void circleDraw(register int x, register int y, int r, int setclear);
